...
/**
 * SwagPaypalV2CommonAddress Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class SwagPaypalV2CommonAddress implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'swag_paypal_v2_common_address';
...
'country_code' => 'getCountryCode'    ];
     ...
     * Sets address_line_1
     *
     * @param string $address_line_1 The first line of the address. For example, number or street. For example, 173 Drury Lane. Required for data entry and compliance and risk checks. Must contain the full address.
     *
     * @return $this
     */
     ...
     * Sets address_line_2
     *
     * @param string $address_line_2 The second line of the address. For example, suite or apartment number.
     *
     * @return $this
     */
     ...
     * Sets admin_area_2
     *
     * @param string $admin_area_2 A city, town, or village. Smaller than $adminArea1
     *
     * @return $this
     */
     ...
     * Sets admin_area_1
     *
     * @param string $admin_area_1 The highest level sub-division in a country, which is usually a province, state, or ISO-3166-2 subdivision. Format for postal delivery. For example, CA and not California.
     *
     * @return $this
     */
