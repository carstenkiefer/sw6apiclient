...
# **createCategory**
> \Swagger\Client\Model\InlineResponse20056 createCategory($body, $_response)
...
# **getCategory**
> \Swagger\Client\Model\InlineResponse20056 getCategory($id)
...
# **getCategoryList**
> \Swagger\Client\Model\InlineResponse20054 getCategoryList($limit, $page, $query)
...
# **updateCategory**
> \Swagger\Client\Model\InlineResponse20056 updateCategory($id, $body, $_response)
